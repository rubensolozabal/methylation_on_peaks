...
[ ! -f data/GM12878_CREB1_peaks.bed.gz ] && wget -O data/GM12878_CREB1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF053UZX/@@download/ENCFF053UZX.bed.gz
[ ! -f data/GM12878_EGR1_peaks.bed.gz ] && wget -O data/GM12878_EGR1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF341EJT/@@download/ENCFF341EJT.bed.gz
...
[ ! -f data/GM12878_wgbs_chg.bigBed ] && wget -O data/GM12878_wgbs_chg.bigBed https://www.encodeproject.org/files/ENCFF647OUR/@@download/ENCFF647OUR.bigBed
[ ! -f data/GM12878_wgbs_chh.bigBed ] && wget -O data/GM12878_wgbs_chh.bigBed https://www.encodeproject.org/files/ENCFF896NCC/@@download/ENCFF896NCC.bigBed
...
[ ! -f data/K562_CREB1_peaks.bed.gz ] && wget -O data/K562_CREB1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF970QKS/@@download/ENCFF970QKS.bed.gz
[ ! -f data/K562_EGR1_peaks.bed.gz ] && wget -O data/K562_EGR1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF136DDO/@@download/ENCFF136DDO.bed.gz
...
[ ! -f data/HepG2_CREB1_peaks.bed.gz ] && wget -O data/HepG2_CREB1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF738LQC/@@download/ENCFF738LQC.bed.gz
[ ! -f data/HepG2_EGR1_peaks.bed.gz ] && wget -O data/HepG2_EGR1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF603PUS/@@download/ENCFF603PUS.bed.gz
...
[ ! -f data/A549_CREB1_peaks.bed.gz ] && wget -O data/A549_CREB1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF390BVP/@@download/ENCFF390BVP.bed.gz
...
#H1
[ ! -f data/H1_CREB1_peaks.bed.gz ] && wget -O data/H1_CREB1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF978KGB/@@download/ENCFF978KGB.bed.gz
[ ! -f data/H1_EGR1_peaks.bed.gz ] && wget -O data/H1_EGR1_peaks.bed.gz https://www.encodeproject.org/files/ENCFF100KKH/@@download/ENCFF100KKH.bed.gz
